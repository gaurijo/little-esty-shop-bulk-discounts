...
RSpec.describe Merchant, type: :model do
  ...
  describe 'model methods' do
    it 'has the top 5 customers by num. of transactions' do
      ...
      merch2item1 = Item.create!(name: 'chair', description: 'furniture', unit_price: 29, merchant_id: merchant2.id)
      merch2item2 = Item.create!(name: 'Crap', description: 'Because you buy stuff for no reason', unit_price: 9999, merchant_id: merchant2.id)
      merch2item3 = Item.create!(name: 'Junk', description: 'You have room', unit_price: 10999, merchant_id: merchant2.id)
      merch2item4 = Item.create!(name: 'BS', description: 'Filling the void in your life', unit_price: 11999, merchant_id: merchant2.id)
      merch3item1 = Item.create!(name: 'Impracticality', description: 'Underselling the other guy', unit_price: 11998, merchant_id: merchant3.id)
      ...
      invoice1_item1 = InvoiceItem.create!(item_id: item1.id, invoice_id: invoice1.id, quantity: 4, unit_price: 43434, status: 2)
      invoice2_item2 = InvoiceItem.create!(item_id: item2.id, invoice_id: invoice2.id, quantity: 5, unit_price: 87654, status: 2)
      invoice3_item3 = InvoiceItem.create!(item_id: item3.id, invoice_id: invoice3.id, quantity: 6, unit_price: 65666, status: 2)
      invoice4_item4 = InvoiceItem.create!(item_id: item4.id, invoice_id: invoice4.id, quantity: 7, unit_price: 65666, status: 2)
      invoice5_item5 = InvoiceItem.create!(item_id: item5.id, invoice_id: invoice5.id, quantity: 8, unit_price: 65666, status: 2)
      invoice6_item6 = InvoiceItem.create!(item_id: item6.id, invoice_id: invoice6.id, quantity: 9, unit_price: 65666, status: 2)
      invoice6_item7 = InvoiceItem.create!(item_id: item6.id, invoice_id: invoice7.id, quantity: 10, unit_price: 61236, status: 1)
      invoice7_item8 = InvoiceItem.create!(item_id: merch2item1.id, invoice_id: invoice8.id, quantity: 10, unit_price: 61299, status: 2)
      ...
      invoice_item8 = InvoiceItem.create!(item_id: merch2item1.id, invoice_id: invoice8.id, quantity: 10, unit_price: 61299, status: 2)
